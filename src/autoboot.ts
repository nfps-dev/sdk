...
export interface AutobootConfig extends PluginConfig {}
...
export function autoboot(gc_export: AutobootConfig={}): RollupPlugin[] {
	// 
	...
	return [
		{
			...
			buildStart() {
				...
				h_env_safe.DEV = 'development' === process.env['NODE_ENV'];
